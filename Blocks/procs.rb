...
puts 'Procs don\'t care about the number of args while lambdas raise exception.'
...
# the use of return
puts 'Lambdas return from itself while Procs return from the calling method.'
...
# If the proc was inside a method, then calling return would be equivalent
# to returning from that method
def call_proc
  puts 'Before proc'
